...
get_template_part('/inc/functions/add-theme-support');
...
get_template_part('/inc/functions/register-nav-menus');
// get_template_part('/inc/functions/register-sidebar');
get_template_part('/inc/functions/add-favicon');
get_template_part('/inc/functions/add-languages');
